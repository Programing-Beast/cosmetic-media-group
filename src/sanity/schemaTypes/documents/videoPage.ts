...
export const videoPage = defineType({
  ...
  type: 'document',
  fields: [
    defineField({name: 'heroTitle', title: 'Hero title', type: 'string', description: 'First part of the heading, e.g. “Video”.'}),
    defineField({name: 'heroAccent', title: 'Hero accent (pink)', type: 'string', description: 'Highlighted end of the heading, e.g. “Gallery.”.'}),
  ...
  preview: {prepare: () => ({title: 'Video page'})}
})
