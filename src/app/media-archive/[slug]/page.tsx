...
export async function generateMetadata({params}: {params: Promise<{slug: string}>}) {
  ...
  if (!article) return {}
  return createMetadata(article.title, article.excerpt, article.seo, `/media-archive/${slug}`)
}
  ...
  return (
    <div className="page-enter">
      <div className="page-hero">
        <div className="shell">
          <div className="crumbs"><Link href="/">Home</Link><span>/</span><Link href="/media-archive">Media Archive</Link><span>/</span><span>{article.category}</span></div>
      ...
      <section>
        <div className="shell article-layout">
          ...
          <aside className="article-aside">
            ...
            <div className="aside-box"><Link className="text-link" href="/media-archive">Back to Media Archive ↗</Link></div>
          </aside>
        </div>
      </section>
    </div>
