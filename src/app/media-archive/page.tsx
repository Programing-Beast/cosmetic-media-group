...
export const metadata = createMetadata('Media Archive', 'Articles, interviews, podcasts, news, trends, opinion and expert content.', {noIndex: true}, '/media-archive')
  ...
  return (
    <div className="page-enter">
      ...
      <section>
        <div className="shell">
          {featured && (
            <Link className="story-card featured" href={`/media-archive/${featured.slug}`}>
